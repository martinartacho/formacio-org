...
<div class="container mx-auto py-8">
    ...
    <div class="mb-8 p-4 border rounded-lg bg-gray-50" 
        ...
        <h2 class="text-xl font-semibold mb-4">2. Dades de pagament</h2>
               ...
               <div class="space-y-3">
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-start p-3 border rounded hover:bg-blue-50 cursor-pointer">
                        ...
                        <div>
                            <span class="font-medium">Cedeixo la titularitat</span>
                            <p class="text-sm text-gray-600 mt-1">
                ...
                <div id="bank-data-fields" style="display: none;">
                  ...
                  {{--   {{ $teacher }} --}}
                    ...
                    <div class="mt-6 p-4 border rounded bg-gray-50">
                        ...
                        <!-- Campo para "Altres" (se muestra solo cuando se selecciona) -->
